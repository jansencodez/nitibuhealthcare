...
const features = [
  {
    icon: <FaBoxOpen className="w-6 h-6 text-teal-600" />,
  ...
  {
    icon: <FaCheckCircle className="w-6 h-6 text-teal-600" />,
  ...
  {
    icon: <FaHandsHelping className="w-6 h-6 text-teal-600" />,
  ...
  {
    icon: <FaDollarSign className="w-6 h-6 text-teal-600" />,
  ...
  {
    icon: <FaLightbulb className="w-6 h-6 text-teal-600" />,
  ...
  {
    icon: <FaHeart className="w-6 h-6 text-teal-600" />,
